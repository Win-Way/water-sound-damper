# ENERGY LOSS ANALYSIS: Dry vs Water-Filled Balls
# Quantifies energy absorption by water sloshing as percentage

print("⚡ ENERGY LOSS ANALYSIS: Water Sloshing Energy Absorption")
print("=" * 70)
...
def calculate_total_energy(signal, dt):
...
def analyze_energy_loss(csv_file, base_freq, dry_baseline_energy=None):
    ...
    try:
        ...
        energy_result = calculate_total_energy(voltage, dt)
...
def create_energy_loss_visualization(all_results):
    """Create visualization of energy loss analysis"""
    ...
    fig.suptitle('Energy Loss Analysis: Water Sloshing Energy Absorption', fontsize=16, fontweight='bold')
...
print("🚀 Starting energy loss analysis...")
